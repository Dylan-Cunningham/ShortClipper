export const CHATGPT_CLIP_SELECTION_PROMPT = `I am giving you a timestamped transcript from a longer video. I want to create 1-3 strong short-form videos from it.
...
- After you produce the JSON block, do not add extra commentary after it.

Here is the transcript:`;

export function buildChatGptPrompt(transcript) {
  return `${CHATGPT_CLIP_SELECTION_PROMPT}\n\n${String(transcript || "").trim()}`;
}
